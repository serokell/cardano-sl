...
projects="networking binary util crypto core db lrc infra ssc txp update delegation block lib node client generator tools wallet wallet-new"
...
commonargs='--test --no-haddock-deps --jobs=4'
